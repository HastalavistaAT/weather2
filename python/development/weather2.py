    ...
    try:
        ...
        try:
            ...
            if lowest_price is not None:
                drawblack.text((232, 52), f"{str(round(lowest_price[1], 1))}", font = fontbold24, align='center', fill = 0, anchor="mm")
                drawblack.text((232, 69), f"ct/kWh", font = font14, align='center', fill = 0, anchor="mm")
                ...
                drawblack.text((232, 97), f"{lowest_price[0].strftime('%H')} Uhr", font = font18, align='center', fill = 0, anchor="mm")
            ...
            if lowest_3_hours is not None and len(lowest_3_hours) == 3:
                ...
                drawblack.text((232, 120), f"Geschirr", font = font16, align='center', fill = 0, anchor="mm")
                today_tomorrow = "morgen"
                ...
                #print(format_seconds_to_hhmm(time_diff.total_seconds()))
        ...
        drawblack.text((100, 166), time, font = fontbold16, align='center', fill = 0, anchor="mm")
